...
// ViewModel for managing list data and search functionality
class ListViewModel: ObservableObject {
    @Published var items: [ListItem] = []
    @Published var searchText: String = ""
    
    init() {
        // Initialize the items for each section
        items = [
            // Text Input/Output section items
